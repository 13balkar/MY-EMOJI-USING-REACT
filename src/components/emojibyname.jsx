...
function SearchbyName(){
    ...
    console.log(v);
    link="https://emoji-api.com/emojis/"+v+"?access_key=171678295c5b133d9eb7e4ef22e7d67ced3c31e3";
    ...
    return (
        <div className="container">
            ...
            {flag===true ? `${""}`:<input id="abc"  onChange={inp} type="text"  placeholder="Enter Emoji Name" />}
